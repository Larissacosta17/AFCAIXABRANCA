 ...
 * @param a primeiro operando
 * @param b segundo operando
 * @if compara o valor de b se é igual a zero
 * @return o resultado da divisão de {@code a} e {@code b} e se b for igual a zero imprime mensagem dizendo que não é permitido
 */
